...
contract UniversalRewardsDistributorTest is Test {
    ...
    function testURDFactoryGenerateCorrectly(address randomCaller, address randomOwner, uint256 randomTimelock,
bytes32 randomRoot, bytes32 randomIpfsHash, bytes32 randomSalt) public {
        ...
        address realAddress = factory.createURD(
            randomOwner,
            randomTimelock,
            randomRoot,
            randomIpfsHash,
